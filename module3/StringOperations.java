...
public static void main(String[] args)  
{
	...
	System.out.println("Upper case of string 1 is: " + str1.toUpperCase());//SACHIN    
	System.out.println("Lower case of string 2 is: " + str2.toLowerCase());//sachin    
	...
	System.out.print("Enter the String which has spaces: ");
   	...
   	System.out.println("Str1 has character at 3rd place as : " + str1.charAt(0));
